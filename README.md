...
Release binaries are Authenticode-signed via **[SignPath Foundation](https://signpath.org/)** / [SignPath.io](https://signpath.io) when OSS signing is enabled — [CODE_SIGNING_POLICY.md](docs/CODE_SIGNING_POLICY.md) · [Privacy](docs/PRIVACY.md).
